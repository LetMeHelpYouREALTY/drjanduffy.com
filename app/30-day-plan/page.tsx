          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto mb-12 prose prose-lg">
              <p className="text-lg text-gray-700 mb-6">
                your home didn\'t sell because your previous agent didn't have a
                plan. They posted to MLS, held maybe one open house, and hoped
                for the best. That's not a strategy. That's incompetence. I have
                a proven 30-day plan that sells homes that DIDN\'T sell. Fast.
                At top dollar. With zero excuses.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                The 30-day plan is broken down into four weeks, each with
                specific goals and deliverables. Week 1 is aggressive reset.
                Week 2 is maximum exposure. Week 3 is negotiation warfare. Week
                4 is closing. Every week has measurable outcomes. Every week
                moves you closer to SOLD.
              </p>
              <p className="text-lg text-gray-700">
                This isn't a theoretical plan. This is the exact system I've
                used to sell 47 Summerlin sellers who couldn\'t sell with an
                average of 19 days to contract and 98.7% of asking price. The
                same system can sell yours. The only question is: are you ready
                to work with an agent who actually has a plan?
              </p>
            </div>
            <div className="max-w-5xl mx-auto space-y-8">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mt-12">
                <h2 className="text-3xl font-black mb-4 text-center">
                  Why the 30-Day Plan Works
                </h2>
                <div className="space-y-6">
                  <div>
                    <h3 className="text-2xl font-bold mb-3">
                      Week 1: Aggressive Reset
                    </h3>
                    <p className="text-lg text-gray-700 mb-4">
                      The first week is critical. This is when we completely
                      reset your listing - new photos, new pricing strategy,
                      fresh MLS listing. We eliminate the stigma of "expired" by
                      making your home look brand new. Professional photography,
                      staging, and 3D virtual tours make buyers forget it ever
                      expired. The aggressive reset is what separates my system
                      from your previous agent's "hope and pray" approach.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-700 mb-4">
                      Week 2 is all about getting your home in front of as many
                      qualified buyers as possible. Strategic open houses with
                      buyer pre-qualification. Network activation reaching 500+
                      agents. Targeted Facebook and Google ads. Email marketing
                      to qualified buyers. Daily follow-up on all showings. This
                      is when the momentum builds and offers start coming in.
                    </p>
                    <h4 className="text-xl font-bold mb-2">Key Deliverables</h4>
                    <ul className="space-y-2 text-gray-700">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">
                      Week 3: Negotiation Warfare
                    </h3>
                    <p className="text-lg text-gray-700 mb-4">
                      Week 3 is when offers come in and negotiations begin. This
                      is where most agents fail. They accept lowball offers or
                      let negotiations drag on. I use aggressive follow-up,
                      buyer psychology tactics, and strategic counter-offers to
                      get you top dollar. I don't wait for offers. I create
                      them. I don't accept lowball offers. I negotiate them up.
                    </p>
                    <h4 className="text-xl font-bold mb-2">Key Deliverables</h4>
                    <ul className="space-y-2 text-gray-700">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">
                      Week 4: Closing & Escrow
                    </h3>
                    <p className="text-lg text-gray-700 mb-4">
                      Week 4 is closing. Escrow management, timeline
