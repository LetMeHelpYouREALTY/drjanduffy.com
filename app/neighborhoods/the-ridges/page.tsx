...
export const metadata = {
  title: 'The Ridges Homes for Sale | Dr. Jan Duffy',
  description:
    'Homes for sale in The Ridges, Summerlin. Luxury golf course properties and estates. 19 day average, 98.7% of asking price.',
  alternates: {
...
export default function TheRidgesPage() {
  const faqs = [
    {
      question: 'Are there homes for sale in The Ridges, Summerlin?',
      answer:
        'Yes. Dr. Jan Duffy represents The Ridges homes for sale in Summerlin. Inventory changes daily. Call (702) 500-1064 for a current search or a CMA at a specific address. She also resets expired The Ridges listings with a 97-point system. Practice results: 7 relisted homes sold, 19-day average to contract, and 98.7% of asking.',
    },
    {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="THE RIDGES HOMES FOR SALE" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  I've sold 7 Summerlin sellers who could not sell with an average of 19 days to contract and 98.7% of asking price. These are not hypothetical results. These are real HOMES FOR SALE that I sold after other agents failed. I can do the same for your Ridges listing. Fast. At top dollar. With zero excuses.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR RIDGES LISTING?"} />
