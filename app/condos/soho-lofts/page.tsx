...
export const metadata = {
  title: 'Soho Lofts Las Vegas for Sale | Dr. Jan Duffy',
  description:
...
export default function SohoLoftsPage() {
  const faqs = [
    {
      question: 'Are there condos for sale at Soho Lofts?',
      answer:
        'Yes. Dr. Jan Duffy represents Soho Lofts condos for sale in Las Vegas. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets Soho Lofts listings that did not sell with a 97-point system and $3,700 photography.',
    },
    {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-black text-center mb-4">
                SOHO LOFTS CONDOS FOR SALE
              </h1>
              <HeadingMedia level={1} heading="SOHO LOFTS CONDOS FOR SALE" />
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Why Soho Lofts Expire" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Soho Lofts Features" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <HeadingMedia level={2} heading="My Soho Lofts Marketing Strategy" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR SOHO LOFTS?"} />
