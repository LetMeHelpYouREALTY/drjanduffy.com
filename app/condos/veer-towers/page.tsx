...
export const metadata = {
  title: 'Veer Towers Condos Las Vegas for Sale | Dr. Jan Duffy',
  description:
...
export default function VeerTowersCondosPage() {
  const faqs = [
    {
      question: 'Are there condos for sale at Veer Towers Condos?',
      answer:
        'Yes. Dr. Jan Duffy represents Veer Towers Condos condos for sale in Las Vegas. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets Veer Towers Condos listings that did not sell with a 97-point system and $3,700 photography.',
    },
    {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="VEER TOWERS CONDOS FOR SALE" />
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR VEER TOWERS CONDO?"} />
