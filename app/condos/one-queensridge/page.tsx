...
export const metadata = {
  title: 'One Queensridge Place Condos for Sale | Dr. Jan Duffy',
  description:
...
export default function OneQueensridgeCondosPage() {
  const faqs = [
    {
      question: 'Are there condos for sale at One Queensridge Place Condos?',
      answer:
        'Yes. Dr. Jan Duffy represents One Queensridge Place Condos condos for sale in Las Vegas. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets One Queensridge Place Condos listings that did not sell with a 97-point system and $3,700 photography.',
    },
    {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="ONE QUEENSRIDGE PLACE CONDOS FOR SALE" />
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Why One Queensridge Place Condos Expire" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="One Queensridge Place Condo Features" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <HeadingMedia level={2} heading="My One Queensridge Place Condo Marketing Strategy" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR ONE QUEENSRIDGE PLACE CONDO?"} />
