...
export const metadata = {
  title: 'Turnberry Place Condos Las Vegas for Sale | Dr. Jan Duffy',
  description:
...
export default function TurnberryPlaceCondosPage() {
  const faqs = [
    {
      question: 'Are there condos for sale at Turnberry Place Condos?',
      answer:
        'Yes. Dr. Jan Duffy represents Turnberry Place Condos condos for sale in Las Vegas. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets Turnberry Place Condos listings that did not sell with a 97-point system and $3,700 photography.',
    },
    {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="TURNBERRY PLACE CONDOS FOR SALE" />
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Why Turnberry Place Condos Expire" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Turnberry Place Condo Features" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <HeadingMedia level={2} heading="My Turnberry Place Condo Marketing Strategy" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR TURNBERRY PLACE CONDO?"} />
