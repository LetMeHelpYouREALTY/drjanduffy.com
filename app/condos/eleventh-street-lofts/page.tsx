...
export const metadata = {
  title: 'Eleventh Street Lofts Las Vegas for Sale | Dr. Jan Duffy',
  description:
...
export default function EleventhStreetLoftsPage() {
  const faqs = [
    {
      question: 'Are there condos for sale at Eleventh Street Lofts?',
      answer:
        'Yes. Dr. Jan Duffy represents Eleventh Street Lofts condos for sale in Las Vegas. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets Eleventh Street Lofts listings that did not sell with a 97-point system and $3,700 photography.',
    },
    {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-black text-center mb-4">
                ELEVENTH STREET LOFTS FOR SALE
              </h1>
              <HeadingMedia level={1} heading="ELEVENTH STREET LOFTS FOR SALE" />
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR ELEVENTH STREET LOFTS?"} />
