...
export const metadata = {
  title: 'Las Vegas Condos for Sale | Luxury, Summerlin & Henderson | Dr. Jan Duffy',
  description:
    'Las Vegas condos for sale — luxury high-rises, Summerlin mid-rises, Henderson condos, and Strip towers. Dr. Jan Duffy also resets condos that did not sell. 19-day average. Call (702) 500-1064.',
  keywords: [
    'las vegas luxury condos for sale',
    'condos in henderson',
    'luxury condos for sale in las vegas',
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes. Dr. Jan Duffy represents luxury condos for sale in Las Vegas, including Strip high-rises, Summerlin mid-rises, and Henderson buildings. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets condos that did not sell with a 97-point marketing system, $3,700 photography, and a 19-day average to contract on relisted homes.',
    },
    {
      question: 'Where can I find condos for sale in Henderson and Summerlin?',
      answer:
        'Start with /condos/henderson and /condos/summerlin. Dr. Jan Duffy covers Green Valley, Anthem, Downtown Summerlin, Affinity Summerlin, and west-valley mid-rises. Call (702) 500-1064 for buildings that match your square footage, HOA budget, and commute.',
    },
    {
      question: 'Are there condos for sale on the Las Vegas Strip?',
      answer:
        'Yes. Strip condo inventory includes Cosmopolitan, Vdara, Veer Towers, and nearby high-rises. See /condos/strip. Dr. Jan Duffy markets Strip condos for buyers and sellers from 1180 N Town Center Dr, Las Vegas, NV 89144. Call (702) 500-1064.',
    },
    {
      question: 'How long does it take to sell a condo in Las Vegas?',
      answer:
        'Dr. Jan Duffy\'s practice average is 19 days from listing to contract on homes that did not sell, including condos. Timing still depends on price, condition, HOA rules, and buyer traffic. Call (702) 500-1064 for a CMA at your address.',
    },
    {
      question: 'Why choose Dr. Jan Duffy for a Las Vegas condo?',
      answer:
        'She invests $5,000+ per listing, takes a maximum of 6 listings, and uses a 97-point system that works inside HOA restrictions. She has sold 7 relisted homes at 98.7% of asking. Office: 1180 N Town Center Dr, Las Vegas, NV 89144.',
    },
  ]
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="Las Vegas Condos for Sale" />
              <p className="text-xl text-center text-gray-600 mb-12">
                Luxury, Summerlin, Henderson, and Strip condos — plus a listing reset if yours already expired
              </p>
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Why Las Vegas Condos Expire" />
                ...
                <HeadingMedia level={3} heading="HOA Restrictions" />
                <p className="text-lg text-gray-700 mb-4">
                ...
                <HeadingMedia level={3} heading="Seasonal Demand Fluctuations" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="My Las Vegas Condo Expertise" />
                <p className="text-lg text-gray-700 mb-4">
                ...
                <HeadingMedia level={3} heading="High-Rise Condos" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <HeadingMedia level={2} heading="The Las Vegas Condo Market Reality" />
                <p className="text-lg text-gray-700 mb-4">
                ...
                <HeadingMedia level={3} heading="Market Statistics" />
                <p className="text-lg text-gray-700 mb-4">
                ...
                <HeadingMedia level={3} heading="Expired Condo Statistics" />
                <p className="text-lg text-gray-700 mb-4">
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <HeadingMedia level={2} heading="EXPLORE LAS VEGAS CONDO CATEGORIES" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <HeadingMedia level={2} heading="Additional Las Vegas condo buildings" />
                <p className="text-center text-lg text-gray-700 mb-6">
