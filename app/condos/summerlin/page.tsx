...
export const metadata = {
  title: 'Summerlin Condos for Sale | Mid-Rise & Townhomes | Dr. Jan Duffy',
  description:
    'Summerlin condos for sale — mid-rises, townhomes, Affinity Summerlin, and Downtown Summerlin. Dr. Jan Duffy also resets condos that did not sell. 19-day average. Call (702) 500-1064.',
  alternates: {
...
export default function SummerlinCondosPage() {
  const faqs = [
    {
      question: 'Are there condos for sale in Summerlin?',
      answer:
        'Yes. Dr. Jan Duffy represents Summerlin condos for sale, including mid-rises, townhomes, Affinity Summerlin, and Downtown Summerlin lock-and-leave residences. Inventory changes daily. Call (702) 500-1064 for a current search. She also resets Summerlin condos that did not sell.',
    },
    {
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <HeadingMedia level={1} heading="SUMMERLIN CONDOS FOR SALE" />
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Summerlin condos require community-focused marketing. Professional photography highlighting community amenities. Strategic positioning against new construction. Emphasis on streets with mature landscaping. Most agents do not understand this. I do. I use community-focused marketing, highlight amenities, and attract community-conscious buyers.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Summerlin has streets with mature landscaping with mature landscaping, proven communities, and existing HOA amenities. I position existing condos by highlighting streets with mature landscaping, showcasing mature landscaping, and emphasizing proven communities. Most agents do not do this. They use generic positioning, and Summerlin condos expire.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Summerlin West offers mid-rise condos and townhomes with mountain views, mature landscaping, and prime location. I've sold expired Summerlin West condos by highlighting mountain views, showcasing mature landscaping, and positioning condos competitively.
                </p>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <HeadingMedia level={2} heading={"READY TO SELL YOUR SUMMERLIN CONDO?"} />
